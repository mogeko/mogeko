...
1. 一个 >= 4g 的U盘
2. Ubuntu 的镜像（建议使用16.04）<URL href="http://www.ubuntu.org.cn/download/desktop" />
3. UltraISO \<- 用来制作引导盘 <URL href="http://cn.ezbsystems.com/ultraiso" />
4. EasyBCD \<- 用来制作、写入引导程序（如果想用 Ubuntu 来引导 Windows 的话也可以不用）<URL href="http://neosmart.net/EasyBCD" />
...
又搞忘截图了 \_(:з)∠)\_ 图片来自 <URL href="http://www.jianshu.com/p/2eebd6ad284d" />
