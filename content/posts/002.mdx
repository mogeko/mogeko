...
1. 一个 GitHub 账号。 \<-我们要使用它提供的 GitHub Pages 服务来搭建博客 <URL href="https://github.com" />
2. Node.js \<- Hexo 依赖于此 <URL href="https://nodejs.org/zh-cn" />
3. Git \<- 用来发布博客 <URL href="https://git-scm.com" />
4. Hexo \<- 博客框架 <URL href="https://hexo.io/zh-cn" />
5. [非必需]Chocolatey \<- 用来安装 Node.js 和 Git <URL href="https://chocolatey.org" />
